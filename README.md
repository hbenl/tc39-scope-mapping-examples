...
- download the [prototype extension](https://github.com/hbenl/vscode-firefox-debug/releases/download/scope-mapping-v3/vscode-firefox-debug-2.15.0.vsix) and install it in VS Code using "Install from VSIX"
